...
class LayerChunkViewable(
    ...
    override fun show(player: Player) {
        val dimensionType = Registries.dimensionType[DimensionTypes.OVERWORLD].value // TODO оно должно браться откуда-нибудь
        val minSection = dimensionType.minY / 16
        val sVoidBlockId = Registries.block[Blocks.STRUCTURE_VOID].value.defaultStateId
