...
sealed class WolfMeta : TameableAnimalMeta() {
    ...
    val VARIANT = index(MetadataEntry.Type.WOLF_VARIANT, Registries.wolfVariant[WolfVariants.PALE].value)
    val SOUND_VARIANT = index(MetadataEntry.Type.WOLF_SOUND_VARIANT, Registries.wolfSoundVariant[WolfSoundVariants.CLASSIC].value)
}