...
class CanPlaceOnComponent(
    ...
    companion object {
        val CODEC = object : Codec<CanPlaceOnComponent> {
            override fun <D> encode(transcoder: Transcoder<D>, value: CanPlaceOnComponent): D {
                TODO("Not yet implemented")
            }

            override fun <D> decode(transcoder: Transcoder<D>, value: D): CanPlaceOnComponent {
                TODO("Not yet implemented")
            }
        }
