...
data class TropicalFishBaseColorComponent(
    val color: DyeColor
) : DataComponent() {

    companion object {
        val CODEC = Codec.enum<DyeColor>().transform(
            ::TropicalFishBaseColorComponent,
            TropicalFishBaseColorComponent::color
        )
        val STREAM_CODEC = StreamCodec.of(
            EnumStreamCodec<DyeColor>(), TropicalFishBaseColorComponent::color,
            ::TropicalFishBaseColorComponent
        )
    }
}