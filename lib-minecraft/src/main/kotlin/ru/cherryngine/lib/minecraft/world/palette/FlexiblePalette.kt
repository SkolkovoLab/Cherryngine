...
import ru.cherryngine.lib.minecraft.world.palette.Palette.EntryConsumer
import ru.cherryngine.lib.minecraft.world.palette.Palette.EntrySupplier
import java.util.*
...
internal class FlexiblePalette @JvmOverloads constructor(// Specific to this palette type
    private val adaptivePalette: AdaptivePalette,
    private var bitsPerEntry: Byte = adaptivePalette.defaultBitsPerEntry
) :
