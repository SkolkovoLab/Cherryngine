...
import ru.cherryngine.lib.minecraft.network.stream_codec.*
...
data class ClientboundSetObjectivePacket(
    ...
    interface Action {
        data class Create(
            ...
            companion object {
                val STREAM_CODEC = StreamCodec.of(
                    ComponentStreamCodecs.NBT, Create::value,
        ...
        data class EditText(
            ...
            companion object {
                val STREAM_CODEC = StreamCodec.of(
                    ComponentStreamCodecs.NBT, EditText::value,
        ...
        interface NumberFormat {
            ...
            data class Styled(
                ...
                companion object {
                    val STREAM_CODEC = StreamCodec.of(
                        BinaryTagStreamCodecs.COMPOUND_STREAM, Styled::styling,
                        ::Styled
                    )
                }
            }
            ...
            data class Fixed(
                ...
                companion object {
                    val STREAM_CODEC = StreamCodec.of(
                        ComponentStreamCodecs.NBT, Fixed::content,
                        ::Fixed
                    )
                }
            }
