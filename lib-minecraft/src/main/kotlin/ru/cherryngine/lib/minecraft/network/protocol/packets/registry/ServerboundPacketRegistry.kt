package ru.cherryngine.lib.minecraft.network.protocol.packets.registry

import ru.cherryngine.lib.minecraft.network.protocol.packets.ProtocolState
import ru.cherryngine.lib.minecraft.network.protocol.packets.common.*
...
import ru.cherryngine.lib.minecraft.network.protocol.packets.login.ServerboundCustomQueryAnswerPacket
import ru.cherryngine.lib.minecraft.network.protocol.packets.login.ServerboundEncryptionResponsePacket
import ru.cherryngine.lib.minecraft.network.protocol.packets.login.ServerboundHelloPacket
...
class ServerboundPacketRegistry : AbstractPacketRegistry() {
    init {
        ...
        register(ProtocolState.LOGIN, ServerboundCookieResponsePacket::class, ServerboundCookieResponsePacket.STREAM_CODEC)
        ...
        register(ProtocolState.CONFIGURATION, ServerboundCookieResponsePacket::class, ServerboundCookieResponsePacket.STREAM_CODEC)
        ...
        register(ProtocolState.PLAY, ServerboundBundleItemSelectedPacket::class, ServerboundBundleItemSelectedPacket.STREAM_CODEC)
        register(ProtocolState.PLAY, ServerboundChangeDifficultyPacket::class, ServerboundChangeDifficultyPacket.STREAM_CODEC)
        register(ProtocolState.PLAY, ServerboundChangeGameModePacket::class, ServerboundChangeGameModePacket.STREAM_CODEC)
        register(ProtocolState.PLAY, ServerboundChatAckPacket::class, ServerboundChatAckPacket.STREAM_CODEC)
        ...
        register(ProtocolState.PLAY, ServerboundChunkBatchReceivedPacket::class, ServerboundChunkBatchReceivedPacket.STREAM_CODEC)
        ...
        register(ProtocolState.PLAY, ServerboundConfigurationAcknowledgedPacket::class, ServerboundConfigurationAcknowledgedPacket.STREAM_CODEC)
        register(ProtocolState.PLAY, ServerboundContainerButtonClickPacket::class, ServerboundContainerButtonClickPacket.STREAM_CODEC)
        ...
        register(ProtocolState.PLAY, ServerboundCookieResponsePacket::class, ServerboundCookieResponsePacket.STREAM_CODEC)
        ...
        register(ProtocolState.PLAY, ServerboundLockDifficultyPacket::class, ServerboundLockDifficultyPacket.STREAM_CODEC)
        ...
        register(ProtocolState.PLAY, ServerboundPaddleBoatPacket::class, ServerboundPaddleBoatPacket.STREAM_CODEC)
        ...
        register(ProtocolState.PLAY, ServerboundPlaceRecipePacket::class, ServerboundPlaceRecipePacket.STREAM_CODEC)
        ...
        register(ProtocolState.PLAY, ServerboundRecipeBookChangeSettingsPacket::class, ServerboundRecipeBookChangeSettingsPacket.STREAM_CODEC)
        register(ProtocolState.PLAY, ServerboundRecipeBookSeenRecipePacket::class, ServerboundRecipeBookSeenRecipePacket.STREAM_CODEC)
        register(ProtocolState.PLAY, ServerboundRenameItemPacket::class, ServerboundRenameItemPacket.STREAM_CODEC)
        register(ProtocolState.PLAY, ServerboundResourcePackPacket::class, ServerboundResourcePackPacket.STREAM_CODEC)
        register(ProtocolState.PLAY, ServerboundSeenAdvancementsPacket::class, ServerboundSeenAdvancementsPacket.STREAM_CODEC)
        register(ProtocolState.PLAY, ServerboundSelectTradePacket::class, ServerboundSelectTradePacket.STREAM_CODEC)
        ...
        register(ProtocolState.PLAY, ServerboundTeleportToEntityPacket::class, ServerboundTeleportToEntityPacket.STREAM_CODEC)
